...
<mm:dataTypeOption dialogProperties="${(dialogProperties + [actionName: 'cleanData', title: 'Clean Data Interpretation']) as JSON}">
...
<mm:dataTypeOption dialogProperties="${(dialogProperties + [actionName: 'rawData', title: 'Raw Data Interpretation']) as JSON}">
	<div class="dataTypeOptionText">
		<b>Raw Data</b><br />
